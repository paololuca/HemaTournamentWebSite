...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="btn-group" runat="server" id="btnDiscipline">
        ...
        <ul class="dropdown-menu" runat="server" id="Ul2">
        </ul>
        <br />
    ...
    <div class="card-action bx-align">
        <h3>Tournament Name :
            <asp:Label ID="lblTournament" runat="server"></asp:Label><br />
            Discipline :
                ...
                <ul class="nav nav-pills mb-4 nav-fill" role="tablist">
                    ...
                    <li class="nav-item">
                        <button
                            ...
                            role="tab"
                            data-bs-toggle="tab"
                            data-bs-target="#navs-pills-justified-stats"
                            aria-controls="navs-pills-justified-stats"
                            aria-selected="false">
